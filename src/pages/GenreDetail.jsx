  ...
  async function getManhwas(url) {
    ...
    if (data) {
      ...
      const prev = pagination.find(
        (p) =>
          p.pageNumber !== "Berikutnya »" &&
          parseInt(p.pageNumber) <
            parseInt(pagination.find((p) => p.pageNumber === "Berikutnya »")?.pageNumber || 2)
      );
          ...
          <div className="w-full flex justify-center my-4 gap-4">
            <button
              ...
              className={`bg-blue-500 text-white font-semibold px-4 py-2 rounded-md ${
                !prevPage || loading ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-600"
              }`}
            >
              Prev Page
            </button>
            ...
            <button
              ...
              className={`bg-blue-500 text-white font-semibold px-4 py-2 rounded-md ${
                !nextPage || loading ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-600"
              }`}
            >
              Next Page
            </button>
